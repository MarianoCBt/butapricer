...
/**
 * Pie con las redes de la tienda. Son las mismas que las de
 * marianocbt.github.io/butatcg, para que se vea que es lo mismo.
 */
export default function Footer() {
  return (
    <footer className="mt-8 border-t border-[var(--color-border)] px-4 py-8">
      <div className="mx-auto flex max-w-2xl flex-col items-center gap-4 text-center text-sm text-[var(--color-muted)]">
        <div className="flex flex-wrap items-center justify-center gap-2">
          <a
            href={config.instagramUrl}
            target="_blank"
            rel="noreferrer noopener"
            className="inline-flex min-h-11 items-center gap-2 rounded-full border border-[var(--color-border)] bg-[var(--color-surface-2)] px-5 py-2.5 font-semibold text-[var(--color-ink)] transition-colors duration-150 hover:border-[var(--color-brand)]"
          >
            <IconoInstagram className="h-4 w-4" />
            {config.instagramUser}
          </a>
          <a
            href={config.tiendaUrl}
            target="_blank"
            rel="noreferrer noopener"
            className="inline-flex min-h-11 items-center gap-2 rounded-full border border-[var(--color-border)] bg-[var(--color-surface-2)] px-5 py-2.5 font-semibold text-[var(--color-ink)] transition-colors duration-150 hover:border-[var(--color-brand)]"
          >
        ...
        <p className="inline-flex flex-wrap items-center justify-center gap-2">
          ...
          <IconoDiscord className="h-4 w-4" />
          <span>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer noopener"
              className="text-[var(--color-brand-ink)] underline transition-opacity duration-150 hover:opacity-80"
            >
              Instagram
            </a>
          </span>
        ...
        {/* En `faint` daba 4,1:1 a 12px, abajo del mínimo AA. */}
        <p className="text-xs">
          Yu-Gi-Oh! es marca registrada de Konami. Este sitio no está afiliado a
          Konami.
        </p>
      </div>
    </footer>
...
function IconoDiscord({ className }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
